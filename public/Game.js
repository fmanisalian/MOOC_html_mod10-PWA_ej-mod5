...
class Game {
    ...
    constructor () {
        ...
        this.score = 0; // Indica la puntuación del usuario                   
    }
    ...
    endGame () {
        ...
        if ((document.getElementById("livesli").innerHTML).slice(7,8) > 0) {     
            let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_WIN_PICTURE);                 
        } else {           
